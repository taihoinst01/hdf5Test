...
class MultiClassDataLoader(object):
    ...
    def define_flags(self):
        self.__flags.DEFINE_string("train_data_file", "app/modelCnn/data/kkk.train", "Data source for the training data.")
        self.__flags.DEFINE_string("dev_data_file", "app/modelCnn/data/kkk.dev", "Data source for the cross validation data.")
        self.__flags.DEFINE_string("class_data_file", "app/modelCnn/data/kkk.cls", "Data source for the class list.")
