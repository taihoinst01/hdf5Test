...
def startEval(ocrData):
    ...
    if FLAGS.checkpoint_dir == "":
        all_subdirs = ["app/modelCnn/runs/" + d for d in os.listdir('app/modelCnn/runs/.') if os.path.isdir("app/modelCnn/runs/" + d)]
    ...
    f = open('app/modelCnn/data/kkk.cls', 'r', encoding="utf-8-sig")
    strList = f.readlines()
